...
function pmn_side_content() {		
	...
	$side_content = '
								<div id="pmn-plugin-info">
										<p><span>'.__( "Author", "plan-my-novel" ).':</span> Jamel Cato </p>
										...
										<p><span>'.__( "Donate", "plan-my-novel" ).':</span> <a href="https://cato.io/plan-my-novel">'.__( "Make a donation", "plan-my-novel" ).'</a></p>																	
								   </div>
